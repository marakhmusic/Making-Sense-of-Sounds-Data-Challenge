...
# X = train_data[:, 0:40]
# y = train_data[:, -1]
Effects_train = newdataX[0:300,:]
Human_train = newdataX[300:600,:]
Music_train = newdataX[600:900,:]
Nature_train = newdataX[900:1200,:]
Urban_train = newdataX[1200:1500,:]
...
def split_the_data_and_normalize(train_cv, test_cv):
    feature_train_cv = train_cv[:, 0:127]
    labels_train_cv = train_cv[:, -1]
    feature_test_cv = test_cv[:, 0:127]
    labels_test_cv = test_cv[:, -1]
